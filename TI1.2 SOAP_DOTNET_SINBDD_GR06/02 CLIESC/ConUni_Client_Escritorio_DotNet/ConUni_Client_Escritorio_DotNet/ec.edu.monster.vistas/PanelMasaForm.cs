...
{
    public partial class PanelMasaForm : Form
    {
        ...
        public PanelMasaForm(string usuario)
        {
            InitializeComponent();
        ...
        private Panel CrearFooterPanel()
        {
            ...
            var btnConvertir = CrearBoton("Convertir", COLOR_MASA, COLOR_MASA_HOVER);
        ...
        private void Convertir()
        {
            try
            {
                ...
                {
                    servicio.KilogramoAGramo(valor, true, out resultadoTemp, out resultadoSpecified);
                    resultado = resultadoTemp;
                }
                else if (origen == "Kilogramo" && destino == "Libra")
                {
                    servicio.KilogramoALibra(valor, true, out resultadoTemp, out resultadoSpecified);
                    resultado = resultadoTemp;
                }
                else if (origen == "Gramo" && destino == "Kilogramo")
                {
                    servicio.GramoAKilogramo(valor, true, out resultadoTemp, out resultadoSpecified);
                    resultado = resultadoTemp;
                }
                else if (origen == "Gramo" && destino == "Libra")
                {
                    servicio.GramoALibra(valor, true, out resultadoTemp, out resultadoSpecified);
                    resultado = resultadoTemp;
                }
                else if (origen == "Libra" && destino == "Kilogramo")
                {
                    servicio.LibraAKilogramo(valor, true, out resultadoTemp, out resultadoSpecified);
                    resultado = resultadoTemp;
                }
                else if (origen == "Libra" && destino == "Gramo")
                {
                    servicio.LibraAGramo(valor, true, out resultadoTemp, out resultadoSpecified);
                    resultado = resultadoTemp;
                }

                string simbolo = destino == "Kilogramo" ? "kg" : destino == "Gramo" ? "g" : "lb";
