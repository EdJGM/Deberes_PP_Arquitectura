...
public class PanelMasaFrame extends JFrame {
    ...
    private static final Color COLOR_MASA = new Color(16, 185, 129);
    ...
    private JPanel createHeaderPanel() {
        ...
        textPanel.setBackground(COLOR_MASA);
        
        JLabel lblTitulo = new JLabel("CONVERSIÓN DE MASA");
        lblTitulo.setFont(new Font("Arial", Font.BOLD, 24));
        lblTitulo.setForeground(Color.WHITE);
        
        JLabel lblDesc = new JLabel("Kilogramos, Gramos, Libras");
    ...
    private JPanel createCenterPanel() {
        ...
        lblOrigen.setAlignmentX(Component.LEFT_ALIGNMENT);
        ...
        lblFlecha.setForeground(COLOR_MASA);
        ...
        resultPanel.setBorder(BorderFactory.createCompoundBorder(
            new LineBorder(COLOR_MASA, 2, true),
        ...
        lblResultado.setForeground(COLOR_MASA);
    ...
    private JPanel createFooterPanel() {
        ...
        JButton btnConvertir = crearBoton("Convertir", COLOR_MASA, COLOR_MASA_HOVER);
